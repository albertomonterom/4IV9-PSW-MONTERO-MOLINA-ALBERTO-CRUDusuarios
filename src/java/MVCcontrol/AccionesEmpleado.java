    ...
    */
    public static int registrarEmpleado(Empleado e){
        ...
        try{
            ...
            String q = "insert into empleados(nom_emp, cel_emp, pass_emp, email_emp, pais_emp) "
                    + "values(?,?,?,?,?)";
    ...
    public static int actualizarEmpleado(Empleado e){
        ...
        try{
            ...
            String q = "update empleados set nom_emp = ?, cel_emp = ?, pass_emp = ?,"
                    +"email_emp = ?, pais_emp"
                    +"where id_emp = ?";
            ...
            estatus = ps.executeUpdate();
            System.out.println("Actualización Exitoso del Empleado");
            con.close();
